...
const STATUS_STEPS = [
    ...
    },
    {
        key: "PICKED_UP",
        title: "Picked up",
        description: "The rider picked up your parcel.",
        icon: Truck,
    },
    {
        key: "AT_SORTING_CENTER",
        title: "At sorting center",
        description: "Your parcel arrived at the sorting center.",
        icon: Package,
    },
    {
        key: "SORTED",
        title: "Sorted",
        description: "Your parcel has been sorted.",
        icon: Check,
    },
    {
...
const STATUS_DESCRIPTIONS = {
    ...
    PICKED_UP: "The rider picked up your parcel.",
    AT_SORTING_CENTER: "Your parcel arrived at the sorting center.",
    SORTED: "Your parcel has been sorted.",
    ...
    RETURNED: "Your parcel was returned.",
};
...
function OrderDetails() {
    ...
    if (loading) {
        return (
            <main className="shop-page order-details-page">
    ...
    return (
        <main className="shop-page order-details-page">
            ...
            <header className="order-details-header">
                ...
                <div
                    className={`order-status-badge status-${currentStatus.toLowerCase()}`}
                >
            ...
            <section className="order-current-status">
